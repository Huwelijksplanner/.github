...
```json  
GET {environment}/api/calendar/availabilitycheck?start=2022-09-21&stop=2022-09-23&interval=1 hours&resources_could[]=resource1Uri&resources_could[]=resource2Uri&resources_could[]=resource3Uri
